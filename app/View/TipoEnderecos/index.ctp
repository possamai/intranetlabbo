                    ...
                    <table class="table table-bordered">
                        <thead>
                          <tr class="head-table">
                                ...
                                <th style="width: 200px;"><?php echo __('Ações'); ?></th>            
                            </tr>                    
                            <tr class="filter">
...
<?php foreach ($tipoEnderecos as $tipoEndereco): ?>
	<tr>
		<td><?php echo h($tipoEndereco['TipoEndereco']['titulo']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link( '<i class="icon16 icomoon-icon-pencil mr0"></i>', array('action' => 'cadastro', $tipoEndereco['TipoEndereco']['id']), array('title'=>'Editar', 'class'=>'btn','escape' => false)); ?>
			<?php echo $this->Html->link( '<i class="icon16 icomoon-icon-remove mr0"></i>', array('action' => 'excluir', $tipoEndereco['TipoEndereco']['id']), array('title'=>'Excluir', 'class'=>'btn confirmLink', 'escape' => false)); ?>
		</td>
	</tr>
<?php endforeach; ?>
