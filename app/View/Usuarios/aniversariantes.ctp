...
<div class="row-fluid">
            ...
            <div class="title clearfix">
                ...
                <div class="content">
                    ...
                    echo $this->Form->create("Filter", array(
                                'url' => array('controller'=>'usuarios', 'action'=>'aniversariantes'),
                                'inputDefaults' => array(
                    ...
                    <table class="table table-bordered">
                        <thead>
                          <tr class="head-table">
                                ...
                                <th><?PHP echo $this->Paginator->sort('nascimento_order', 'Aniversário<span class="order"></span>', array('escape' => false)); ?></th>
                            </tr>                    
                            <tr class="filter">
                                <th>&nbsp;</th>
                        	    ...
                        	    <th><?PHP echo $this->Form->input('data_nascimento', array(
                                                                                        'label'=>false,
                                                                                        'empty' => '',
                                                                                        'options'=>array('01'=>'Janeiro','02'=>'Fevereiro','03'=>'Março',
	...
	<tr>
		...
		<td><?php echo h( date('d/m', strtotime($usuario['Usuario']['data_nascimento'])) .'/'. date('Y')    ); ?>&nbsp;</td>
	</tr>
<?php endforeach; ?>
