...
<div class="row-fluid">
    <div class="span12">
        ...
        <?php foreach ($rebaixos as $rebaixo): ?>
	<tr>
		<td><?php echo h($rebaixo['Rebaixo']['titulo']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link( '<i class="icon16 icomoon-icon-pencil mr0"></i>', array('action' => 'cadastro', $rebaixo['Rebaixo']['id']), array('title'=>'Editar', 'class'=>'btn','escape' => false)); ?>
			<?php echo $this->Html->link( '<i class="icon16 icomoon-icon-remove mr0"></i>', array('action' => 'excluir', $rebaixo['Rebaixo']['id']), array('title'=>'Excluir', 'class'=>'btn confirmLink', 'escape' => false)); ?>
		</td>
	</tr>
<?php endforeach; ?>
