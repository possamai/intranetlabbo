...
<div class="row-fluid">
    <div class="span12">
        ...
        <?php foreach ($categoriaArquivos as $categoriaArquivo): ?>
	<tr>
		<td><?php echo h($categoriaArquivo['CategoriaArquivo']['titulo']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link( '<i class="icon16 icomoon-icon-pencil mr0"></i>', array('action' => 'cadastro', $categoriaArquivo['CategoriaArquivo']['id']), array('title'=>'Editar', 'class'=>'btn','escape' => false)); ?>
			<?php echo $this->Html->link( '<i class="icon16 icomoon-icon-remove mr0"></i>', array('action' => 'excluir', $categoriaArquivo['CategoriaArquivo']['id']), array('title'=>'Excluir', 'class'=>'btn confirmLink', 'escape' => false)); ?>
		</td>
	</tr>
<?php endforeach; ?>
