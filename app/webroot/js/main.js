...
Modernizr.load({
  ...
  nope: 'js/plugins/forms/placeholder/jquery.placeholder.min.js',
  complete: function () {
...
Modernizr.load({
  ...
  yep: ['js/plugins/fix/ios-fix/ios-orientationchange-fix.js', 'js/plugins/fix/touch-punch/jquery.ui.touch-punch.min.js']
});
